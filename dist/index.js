...
var _=require('@stdlib/blas-base-assert-is-layout/dist'),O=require('@stdlib/blas-base-assert-is-matrix-triangle/dist'),B=require('@stdlib/strided-base-stride2offset/dist'),d=require('@stdlib/error-tools-fmtprodmsg/dist'),C=E();function D(i,r,e,s,n,a,m){var t;if(!_(i))throw new TypeError(d('1z9Fx',i));if(!O(r))throw new TypeError(d('1z9Fy',r));if(e<0)throw new RangeError(d('1z9Fz',e));if(a===0)throw new RangeError(d('1z9GB',a));return e===0||s===0?m:(t=B(e,a),C(i,r,e,s,n,a,t,m,1,0))}T.exports=D
});var S=c(function(A,j){
var G=require('@stdlib/blas-base-assert-is-layout/dist'),H=require('@stdlib/blas-base-assert-is-matrix-triangle/dist'),p=require('@stdlib/error-tools-fmtprodmsg/dist'),I=E();function J(i,r,e,s,n,a,m,t,v,x){if(!G(i))throw new TypeError(p('1z9Fx',i));if(!H(r))throw new TypeError(p('1z9Fy',r));if(e<0)throw new RangeError(p('1z9Fz',e));if(a===0)throw new RangeError(p('1z9GB',a));if(v===0)throw new RangeError(p('1z9GS',v));return e===0||s===0?t:I(i,r,e,s,n,a,m,t,v,x)}j.exports=J
